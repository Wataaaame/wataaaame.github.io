...
- [生活里重要的东西都是免费的｜财务自由实证 #78](https://mp.weixin.qq.com/s/d1BOF_ucVm5MdtdALkxkiA)

  各种消费都要支付两次才能生效：第一次支付是购买的金钱，第二次支付则是使用的时间

  > 典型的【我花钱买的游戏还要花时间玩？】
  >
  > 引进新的快乐不如改善旧的痛苦：因为旧的习惯已经养成，自然而然地在支付使用时间；而新的习惯往往缺乏切实的体验，容易被搁置掉（例如放假前立的各种计划）
  >
  > 所以，可以更多地关注第二次支付，给它们留出使用时间
  >
  > 10-09

- [把你变成僵尸，只需要一根冰锥……](https://mp.weixin.qq.com/s/0OjYPy8XSXJc8nnQ98uuKA)
  ...
  > 不要无依据的空想、也不要无思考的盲从
  > 
  > 通过主动行动 + 深度思考，进而形成可靠又独特的观点，实现个人价值和认知的双重提升
  > 
  > 10-13
