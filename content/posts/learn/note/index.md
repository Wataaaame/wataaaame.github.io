...
>   时间管理是通过计划和有意识地控制在特定活动上的时间花费以提升效率的一个过程——维基百科

放到具体场景中来看，要处理的事情无非工作、生活两块

而时间管理工具能帮我们解决的问题也是两块

1.   提醒（不要忘记做某件事）
2.   计划（把大的内容拆成许多小的步骤去执行）

![时间管理需求场景](./assets/时间管理需求场景.jpg)

把时间管理工具的使用场景、及其提供的功能价值交叉，可以得到一个矩阵（如上图）

这张图上标记了两块区域，分别对应「生活提醒」与「工作计划」

代表时间管理工具适用场景：

-   生活事务（提醒更重要）

    一般都是可以直接行动的事情，不需要拆分计划
...
-   工作事务（计划梳理更重要）
    ...
    >   不需要提醒，工作不按时完成，老板、同事一定会不停督促你，甚至拿钉钉这样的变态工具滴滴你

总而言之

-   在工作场景中，我们需要的是能辅助我们思考并寻找任务最优可执行路径的工具

-   在生活场景中，我们需要的则是一个简单易用的提醒工具
...
目前主流工具以清单类和日程类为主，部分会集成如番茄钟、四象限之类的功能

这部分主要关注清单、日程在产品形态上的差异

笔记似乎不常被归入时间管理的范畴，但在「在工作场景中，我们需要的是能辅助我们思考并寻找任务最优可执行路径的工具」的前提下，笔记天生适用于这个需求
